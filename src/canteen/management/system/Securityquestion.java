...
public class Securityquestion extends javax.swing.JFrame {
    ...
    public Securityquestion(String email) {
        initComponents();
        useremail = email;
    ...
    public void Validatefields() {
        String newquestion = txtnew.getText();
        String answer = txtanswer.getText();
        String password = txtpassword.getText();
        if (!password.equals("") && !newquestion.equals("") && !answer.equals("")) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtold, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 250, 282, -1));
        ...
        getContentPane().add(txtnew, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 310, 282, -1));
        ...
        getContentPane().add(txtanswer, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 360, 282, -1));
        ...
        getContentPane().add(txtpassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 420, 282, -1));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -2, 1370, 770));
    ...
    private void btnclearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnclearActionPerformed
        setVisible(false);
        new Securityquestion(useremail).setVisible(true);
        // TODO add your handling code here:
...
// TODO add your handling code here:
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        String answer = txtanswer.getText();
        String password = txtpassword.getText();
        userdao.Changesecurityquestion(useremail, password, newquestion, answer);
        setVisible(false);
        new Securityquestion(useremail).setVisible(true);
// TODO add your handling code here:
